...
class JoinViewModel( dataManager: DataManager, schedulerProvider: SchedulerProvider)
    : BaseViewModel<JoinNavigator>( dataManager, schedulerProvider) {

    val margin = ObservableInt(40)
    val classCode = ObservableField("")
